...
defined('ROOT_PATH') or define('ROOT_PATH','D:\\work\\shichuanxuexiao\\cms');
defined('ROOT_URL') or define('ROOT_URL','http://www.scxxwh.com');
...
defined('_PHP_FILE_') or define('_PHP_FILE_','/admin.php');
...
L(array (
  ...
  'data_cache_path' => './admin/Runtime/Temp/',
